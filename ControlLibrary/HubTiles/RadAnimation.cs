...
namespace ControlLibrary
{
	...
	{
        /// <summary>
        /// The Emtpy animation does nothing and must be used instead of null if no animation should be played.
        /// </summary>
        ...
        /// </summary>
        public AnimationFillBehavior FillBehavior
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Gets or sets the repeat behavior of this RadAnimation instace.
        /// </summary>
        ...
        /// </summary>
        internal RadAnimationGroup Parent
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Removes any property modifications, applied to the specified element by this istance.
        /// </summary>
        ...
        internal FillBehavior GetFillBehavior()
        {
            ...
            return System.Windows.Media.Animation.FillBehavior.HoldEnd;
        }

        internal virtual IEasingFunction ComposeEasingFunction()
        {
            if (this.easing == null)
            {
                if (this.Parent != null)
